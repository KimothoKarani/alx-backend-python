#!/usr/bin/env python3
"""
Fixtures for testing the GitHub organization client.
This module contains sample payloads from the GitHub API to be used in tests,
preventing the need for actual network calls.
"""
